...
\palavraschave{palavrachave1; palavrachave2; palavrachave3.}  % 3-6 palavras-chave
\keywords{keyword1; keyword2; keyword3.}   % 3-6 palavras-chave para resumo em inglês

\DEELautor{Giovanni}{Aurelio} % Aluno autor do trabalho
...
\DEELdedicatoria{Dedico este trabalho a todos que me ajudaram a superar os desafios, em especial, os meus colegas da turma Elétrica 019. Sem vocês, tudo seria mais difícil.}  
    
% Texto dos Agradecimentos (OBS: Agradecimentos é opcional)
% Caso não queira inserir, deixe em branco ( \agradecimentos{} )
\DEELagradecimentos{Agradeço a meu pai, minha mãe.} 
...
horárias das termoelétricas brasileiras. Este trabalho inclui análises para quatro termoelétricas 
...
This work includes analyses for four thermal power plants with different generation capacities, 
...
\include{capitulos/4_desenvolvimento} % Texto do cap4.tex
...
\appendix
\include{apendices/1_apendice1}   % Arquivo apendice_1.tex
...
\appendix
\include{anexos/1_anexo}  % Arquivo anexo_1.tex
