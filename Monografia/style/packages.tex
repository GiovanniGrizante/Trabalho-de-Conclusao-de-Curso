...
\usepackage{tabularx}       % Para tabelas com largura flexível
\usepackage{ltablex}
\usepackage{fvextra}
\usepackage[list=true]{subcaption}
\usepackage{listings}
\usepackage{chngcntr}
\DeclareCaptionType{listing}[Pseudocódigo][Lista de Pseudocódigos]
...
\usepackage[printonlyused]{acronym}	   % Usado para gerenciar e imprimir siglas
