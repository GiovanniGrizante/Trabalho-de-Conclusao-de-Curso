...
\begin{acronym}[itemsep=0pt]
    ...
    \acro{SBCE}{Sistema Brasileiro de Comércio de Emissões de Gases de Efeito Estufa}
    \acro{CEMS}{\emph{Continuous Emissions Monitoring System}}
    \acro{AR5}{\emph{Fifth Assessment Report}}
    \acro{IPCC}{\emph{Intergovernmental Panel on Climate Change}}
    \acro{MAPE}{\emph{Mean Absolute Percentage Error}}
    \acro{CEM}{\textit{Continuous Emissions Monitoring System}}
