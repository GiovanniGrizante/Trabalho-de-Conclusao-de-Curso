...
Foram realizados experimentos para os dois cenários propostos na metodologia: calibração padrão e calibração com regularização L2 (\(\lambda = 30\)). Para cada cenário, calibrou-se a equação de emissão para 39 usinas termelétricas no período de 2020 a 2024, geraram-se as emissões sintéticas horárias e treinou-se uma rede neural \ac{MLP} com a arquitetura descrita na Seção 3.7. O conjunto de treinamento compreendeu os anos de 2020 a 2022, o conjunto de validação o ano de 2023, e o conjunto de teste o ano de 2024.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \label{fig:hist_L2}
    \end{subfigure}
    \caption{Quantidade de Usinas por Erro \ac{MAE}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \label{fig:dist_L2}
    \end{subfigure}
    \caption{Distribuição das Usinas por Erro \ac{MAE}}
    \label{fig:distr_mae}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Relação entre \ac{MAE} e Instabilidade}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \label{fig:mse_l2}
    \end{subfigure}
    \caption{Relação entre \ac{MAE} e \ac{MSE}}
    \label{fig:mae_X_mse}
\end{figure}
